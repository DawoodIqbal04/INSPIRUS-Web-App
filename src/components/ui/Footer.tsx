    ...
    <section className="pt-20 bg-whital px-6">
      <div className="w-full h-[80vh] bg-dark rounded-t-[45px] p-14">
        ...
        <div className="w-full flex items-center justify-between mt-10">
            <div className={`${grotesk.className} w-[25%] text-white flex flex-col items-start gap-5`}>
            ...
            <div className="w-[65%] h-48 px-10 flex justify-between items-center rounded-2xl bg-[#292A32] ">
