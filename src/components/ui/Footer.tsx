    ...
    <section className="pt-20 bg-whital md:px-6">
      <div className="w-full md:h-[80vh] min-h-[100vh] bg-dark md:rounded-t-[45px] rounded-t-4xl lg:p-14 md:p-8 p-4 pt-12">
        ...
        <div className="w-full flex lg:flex-row flex-col items-center justify-between lg:mt-10 mt-16 ">
          ...
          <div className="lg:w-[65%] w-full lg:mt-0 mt-20 md:h-48 h-56 px-10 flex md:flex-row flex-col md:justify-between justify-evenly items-center rounded-2xl bg-[#292A32] ">
            <input
              type="text"
              placeholder="Email"
