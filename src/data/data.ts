...
export const titles = [
  ...
  {
    title: 'For a B2B software company, we designed a tailored UX and frontend system that improved user engagement and led to a 200% increase in demo requests..'
  },
  {
